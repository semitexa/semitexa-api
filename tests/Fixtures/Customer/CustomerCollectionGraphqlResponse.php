 ...
 */
#[ProducesResourceCollection(CustomerResource::class, description: 'GraphQL encoding of the customer collection.')]
#[CollectionSortable(['id', 'name'])]
#[CollectionFilterable([
    'id'   => ['eq', 'in'],
    'name' => ['eq', 'contains'],
])]
final class CustomerCollectionGraphqlResponse
{
}
